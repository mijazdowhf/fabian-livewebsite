...
Route::middleware('admin')->group(function () {
    ...
    Route::name('personal.loans.')->prefix('personal-loans')->controller('PersonalLoanController')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('details/{id}', 'details')->name('details');
        Route::post('status/{id}', 'updateStatus')->name('status');
        Route::post('assign-agent/{id}', 'assignAgent')->name('assign.agent');
        Route::post('delete/{id}', 'delete')->name('delete');
    });

    //============Employee Loan Applications================//
    Route::name('employee.loans.')->prefix('employee-loans')->controller('EmployeeLoanController')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('details/{id}', 'details')->name('details');
        Route::post('status/{id}', 'updateStatus')->name('status');
        Route::post('assign-agent/{id}', 'assignAgent')->name('assign.agent');
    ...
    Route::name('selling.mortgages.')->prefix('selling-mortgages')->controller('SellingMortgageController')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('details/{id}', 'details')->name('details');
        Route::post('status/{id}', 'updateStatus')->name('status');
        Route::post('assign-agent/{id}', 'assignAgent')->name('assign.agent');
    ...
    // Agents Manager
    Route::controller('ManageUsersController')->name('agents.')->prefix('agents')->group(function(){
    ...
    //============Agent Packages================//
    Route::controller('PackageController')->prefix('packages')->name('packages.')->group(function(){
        Route::get('/', 'index')->name('index');
        Route::post('update/{id}', 'update')->name('update');
        Route::post('toggle-status/{id}', 'toggleStatus')->name('toggle.status');
        Route::post('update-referral-bonus', 'updateReferralBonus')->name('update.referral.bonus');
    });

    //============Activity Logs================//
    Route::controller('ActivityLogController')->prefix('activity-logs')->name('activity.logs.')->group(function(){
        Route::get('/', 'index')->name('index');
        Route::get('agent-activities/{agent_id?}', 'agentActivities')->name('agent.activities');
        Route::get('user-activities/{user_id}', 'userActivities')->name('user.activities');
        Route::get('application/{type}/{application_id}', 'applicationActivities')->name('application.activities');
        Route::get('details/{id}', 'details')->name('details');
    ...
    // Admin Support - COMMENTED OUT (Using Agent-User Messaging instead)
