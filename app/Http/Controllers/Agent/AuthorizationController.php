...
class AuthorizationController extends Controller
{
    ...
    public function authorizeForm()
    {
        ...
        if (!$user->status) {
            ...
            // Agent is fully verified, redirect to appropriate page
            if (!$user->profile_complete) {
                return to_route('agent.data');
            }
            if (!$user->paid_package_agent) {
        ...
        return view('Template::agent.auth.authorization.'.$type, compact('user', 'pageTitle'));
