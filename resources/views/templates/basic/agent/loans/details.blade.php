...
<div class="row mb-none-30">
    <div class="col-12">
        <div class="card b-radius--10 overflow-hidden box--shadow1">
            <div class="card-body">
                <h5 class="mb-20 text-muted">@lang('Loan Application Details')</h5>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><strong>@lang('Age'):</strong> {{ $loan->age }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><strong>@lang('Loan Type'):</strong> {{ ucfirst(str_replace('_', ' ', $loan->loan_type)) }}</p>
