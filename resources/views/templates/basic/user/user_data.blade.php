                ...
                <div class="card custom--card">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            <div class="d-inline-block rounded-circle mb-3" style="background: linear-gradient(135deg, #025AA3 0%, #0373cc 100%); padding: 20px;">
                                <i class="las la-user-edit text-white" style="font-size: 48px;"></i>
                            </div>
                            <h4 class="text-dark fw-bold text-capitalize mb-2">
                                @lang('Please complete your profile')
                            </h4>
                            <p class="text-muted">@lang('Fill in your details to get started')</p>
                        </div>
