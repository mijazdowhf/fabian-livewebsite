        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-menu align-items-lg-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ menuActive('loan.type.selector') }}" href="{{ route('loan.type.selector') }}">@lang('Loan Application')</a>
                    </li>
                    <li class="nav-item">
    ...
    <script>
        (function($) {
            ...
            $langListItem.each(function() {
                ...
                const langCode = $innerItem.data('code');

                $innerItem.on("click", function(e) {
                    // Redirect to language change route
                    window.location.href = "{{ route('lang', '') }}/" + langCode;
                });
            });
