<div class="dashboard-sidebar" id="dashboard-sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="{{ route('user.applications') }}" class="{{ menuActive('user.applications') }}">
                <img src="{{ asset($activeTemplateTrue . '/images/icon/balance-transfer.png') }}">@lang('My Applications')
            </a></li>
        ...
        <li><a href="{{ route('user.contact.agent') }}" class="{{ menuActive('user.contact.agent*') }}">
                <img src="{{ asset($activeTemplateTrue . '/images/icon/ticket.png') }}">@lang('Contact My Agent')</a></li>
