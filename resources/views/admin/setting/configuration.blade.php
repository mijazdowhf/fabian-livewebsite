                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div class="flex-grow-1">
                                <p class="fw-bold mb-0">@lang('Referral Commission Rate') (%)</p>
                                <p class="mb-0">
                                    <small>@lang('Set the commission percentage that referring agents earn when their referred agents purchase packages. Default is 10%.')</small>
                                </p>
                            </div>
                            <div class="form-group" style="width: 150px;">
                                <div class="input-group">
                                    <input type="number" class="form-control" name="referral_commission_rate" value="{{ gs('referral_commission_rate') ?? 10 }}" min="0" max="100" step="0.01" required>
