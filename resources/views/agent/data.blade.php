                ...
                <div class="card custom--card">
                    <div class="card-body">
                        <h4 class="text-capitalize text-center mb-4 mt-0">
                            @lang('Please complete your agent profile')
                        </h4>
                        <form method="POST" action="{{ route('agent.data.submit') }}" class="row g-4">
                            @csrf
                                ...
                                <div class="custom--nice-select auth-form__input-group">
                                    ...
                                    <select name="country">
                                        @foreach ($countries as $key => $country)
                                            <option data-mobile_code="{{ $country->dial_code ?? '' }}" value="{{ $country->country ?? $key }}" data-code="{{ $key }}">
                                                {{ __($country->country ?? $key) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="auth-form__input-group">
                                    ...
                                    <input type="text" name="city" class="auth-form__input checkUser" value="{{ old('city') }}" placeholder="@lang('City')" required autofocus="off" />
                                </div>
                            </div>
